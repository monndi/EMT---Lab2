...
public class AuthorRestController {
    ...
    @PostMapping("/add")
    public ResponseEntity<Author> save(@RequestParam String name, @RequestParam String surname, @RequestParam  Long country_id ) {
        return this.authorService.save(name, surname, country_id)
                .map(author -> ResponseEntity.ok().body(author))
